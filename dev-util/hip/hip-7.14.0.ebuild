...
if [[ ${PV} == 9999 ]]; then
	...
	SRC_URI="
		https://github.com/ROCm/rocm-systems/releases/download/${ROCM_TAG}/clr.tar.gz -> rocm-clr-${PV}.tar.gz
		https://github.com/ROCm/rocm-systems/releases/download/${ROCM_TAG}/${PN}.tar.gz -> ${P}.tar.gz
		test? (
			https://github.com/ROCm/rocm-systems/releases/download/${ROCM_TAG}/hip-tests.tar.gz -> hip-tests-${PV}.tar.gz
		)
	"
	S="${WORKDIR}/clr/"
